                ...
                with tf.python_io.TFRecordWriter(output_filename) as tfrecord_writer:
                    ...
                    for i in range(start_ndx, end_ndx):
                        try:
                            ...
                            # 生成tfrecord文件
                            example = image_to_tfexample(image_data, b'png', class_id)
...
if __name__ == '__main__':
    ...
    if _dataset_exists(DATASET_DIR):
        ...
        training_filenames = photo_filenames[_NUM_TEST:]  # 划分训练集
        testing_filenames = photo_filenames[:_NUM_TEST]  # 划分测试集
